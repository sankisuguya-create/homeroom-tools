...
assert.ok(dist.includes('grid-template-columns:repeat(6,minmax(0,1fr))'));
...
const context={TEST_TAGS:tagsText,RESULT:null,localStorage:{getItem:()=>null,setItem:()=>{}},document:{getElementById:()=>null},URL,URLSearchParams,console};
